...
class Settings(BaseSettings):
    ...
    did_api_base_url: str = Field(default="https://api.d-id.com", alias="DID_API_BASE_URL")
    did_default_source_image_url: str = Field(default="", alias="DID_DEFAULT_SOURCE_IMAGE_URL")
    sync_api_key: str = Field(default="", alias="SYNC_API_KEY")
    sync_api_base_url: str = Field(default="https://api.sync.so/v2", alias="SYNC_API_BASE_URL")
    sync_default_source_video_url: str = Field(default="", alias="SYNC_DEFAULT_SOURCE_VIDEO_URL")
    sync_default_source_image_url: str = Field(default="", alias="SYNC_DEFAULT_SOURCE_IMAGE_URL")
    sync_default_model: str = Field(default="lipsync-2", alias="SYNC_DEFAULT_MODEL")
