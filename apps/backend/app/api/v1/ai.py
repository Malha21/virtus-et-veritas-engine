...
from app.schemas.ai import GenerateStructureRequest, GenerateStructureResponse
...
def generate_structure(
    ...
    result = generate_project_structure(db, current_user, project_id, generation_language)
