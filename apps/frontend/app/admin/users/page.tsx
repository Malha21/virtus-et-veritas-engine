...
function AdminUsersContent({ currentUser }: { currentUser: CurrentUser }) {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <p className="text-sm text-gold-400">Administração</p>
      ...
      <form onSubmit={handleCreate} className="mt-8 grid gap-5 rounded-lg border border-white/10 bg-white/[0.035] p-6">
      ...
      <section className="mt-8 rounded-lg border border-white/10 bg-white/[0.035] p-5">
        ...
        {loading ? (
          ...
          <p className="mt-4 text-sm text-slate-400">Nenhum usuário encontrado.</p>
        ) : (
                ...
                <div className="flex items-center gap-3">
                  ...
                  {user.id !== currentUser.id ? (
                    <button
                      ...
                      className="rounded-md border border-white/10 px-3 py-2 text-sm text-slate-200 transition hover:border-gold-500/40"
                    >
