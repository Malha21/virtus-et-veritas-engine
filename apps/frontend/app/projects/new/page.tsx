  ...
  return (
    <AppShell>
      <div className="mx-auto max-w-3xl">
        <p className="font-mono text-xs uppercase tracking-wider text-accent-400">Novo Projeto</p>
        <h1 className="mt-2 text-3xl font-semibold">Criar produção educacional</h1>
        <p className="mt-2 text-zinc-400">Nesta fase, o tipo habilitado é curso.</p>

        <form onSubmit={handleSubmit} className="mt-8 grid gap-5 rounded-lg border border-white/5 bg-white/[0.035] p-6">
          ...
          <label className="grid gap-2 text-sm text-zinc-200">
            ...
            <textarea
              ...
              rows={5}
              className="rounded-md border border-white/5 bg-navy-950 px-3 py-3 text-white outline-none focus:border-accent-500"
            />
          </label>
